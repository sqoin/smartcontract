...
contract Sale {
    ...
    function Sale(address _wallet) {
        ...
        maxMintable = 90000000000000000000000000000000000000; // 3 million max sellable (18 decimals)
        ETHWallet = _wallet;
        isFunding = true;
        creator = msg.sender;
        createHeldCoins();
    ...
    function createHeldCoins() internal {
        ...
        createHoldToken(0x22d505DCC5a360e6679210415b81Fb891C28Fba8, 100000000000000000000000);
        createHoldToken(0xDE6710b0955380094B61ed82c4b5E6503861D7eC, 100000000000000000000000);
    }
